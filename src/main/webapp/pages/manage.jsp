...
<nav class="navbar navbar-expand-lg navbar-dark">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item">
                <a class="nav-link" href="/reception/addPatient">+ Add Patient</a>
            </li>
            <li class="nav-item">
...
<div class="container">
	<div class="row">
        ...
        <form action="/reception/searchByName" method="post" autocomplete="off">
        <div class="form-group position-relative">
            <input type="text" id="searchField" class="form-control" name="fullName" placeholder="Search...">
            <div id="suggestionsDiv" class="suggestions"></div>
        </div>
  ...
  <div class="row g-0">
    <div class="col-md-4">
      <c:choose>
                 <c:when test="${not empty e.base64Image}">
                   <img src="data:image/png;base64,${e.base64Image}" class="img-fluid rounded-start" alt="...">
                   </c:when>
                   <c:otherwise>
    ...
    <div class="col-md-8">
      <div class="card-body">
        ...
        <p class="card-text">Birth Date : ${e.birth_date }       Age: ${e.age} years</p>
